...
const Category = () => {
  ...
  return (
    <div className="w-full lgl:w-[850px] h-[200px] md:h-[150px] bg-bodyColor flex flex-col md:flex-row items-center justify-start rounded-3xl">
      <div className="w-full md:w-1/6 h-full rounded-3xl">
        <button
          onClick={() =>
          ...
          className="categoryP rounded-tl-3xl"
        >
          Personal
        </button>
        <button
        ...
        <button
          ...
          className="categoryP rounded-bl-3xl"
        >
          Others
        </button>
      </div>
